...
<td>${app.titulo}</td> <td>${app.plataforma}</td> <td>${app.idioma}</td> <td>${app.precio}</td> <td>${app.descripcion}</td> <td>${app.enlace}</td><td class="danger"><a href="" class="btn btn-default btn-xs">Eliminar</a></td>
</tr>
</#list>
</table>
</div>
